 ...
 * @ingroup BoardIO
 */
class Acceleration_Sensor : public IO_Device, public I2C_Device_Base, public SingletonTemplate<Acceleration_Sensor>
{
    public:
        ...
        const char* getValueAsString(); ///< @returns string containg X : Y : Z values
