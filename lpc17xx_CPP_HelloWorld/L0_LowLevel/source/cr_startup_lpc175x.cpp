...
void ResetISR(void)
{
    ...
    extern void lowLevelInitialize();
    extern void highLevelInitialize();
    extern int main();
    ...
    uart0Puts("Unexpected exit from main()");
    while (1)
        ;
}
...
{
    printMessageUponCriticalSystemError("BUS Fault\n");
    while (1)
    {
    }
}
...
{
    printMessageUponCriticalSystemError("SVC Fault\n");
    while (1)
    {
    }
}
