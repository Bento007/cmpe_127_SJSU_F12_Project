 ...
 */
	...
	static void prvListTaskWithinSingleList( const signed char *pcWriteBuffer, xList *pxList, signed char cStatus, unsigned long ulTotalRunTime) PRIVILEGED_FUNCTION;
	...
	void vTaskResetRunTimeStats()
	{
	    ...
	    vTaskSuspendAll();
	    {
	        ...
	        do
	        {
	            ...
	            if( listLIST_IS_EMPTY( &( pxReadyTasksLists[ uxQueue ] ) ) == pdFALSE )
	            {
	                prvResetRunTimeStatsInList(( xList * ) &( pxReadyTasksLists[ uxQueue ] ) );
	            }
	        }while( uxQueue > ( unsigned short ) tskIDLE_PRIORITY );
...
/*-----------------------------------------------------------*/
	...
	register unsigned short usCount = 0;
		...
		// Report the size in bytes rather than 32-bits
